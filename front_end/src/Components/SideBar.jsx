        ...
        <div className='SideBar'>
            ...
            <ul className="middle">
                ...
                <li>
                    ...
                    <NavLink to="/main">massages</NavLink>
                </li>
                <li>
                    <svg aria-label="New post" class="x1lliihq x1n2onr6 x5n08af" fill="currentColor" height="24" role="img" viewBox="0 0 24 24" width="24"><title>New post</title>
                    ...
                    <NavLink onClick={togglePostDisplay} to="/main">create</NavLink>
                </li>
                <li>
                    <svg xmlns="http://www.w3.org/2000/svg" id="Outline" viewBox="0 0 24 24" width="512" height="512">
